...
const CoverPopover = () => {
  ...
  return (
    <Container>
      ...
      <SizeContainer>
        <SizeWrapper
          onClick={() => handleColorClick(card.cover?.color, true)}
          show={card.cover?.color}
        >
          <SizeTypeOne
            selected={
              card.cover?.color &&
        ...
        <SizeWrapper
          onClick={() => handleColorClick(card.cover?.color, false)}
          show={card.cover?.color}
        >
          <SizeTypeTwo
            selected={
          ...
          return (
            <ColorBox
              onClick={() => {
                handleColorClick(
                  color.bg,
                  card.cover?.isSizeOne === null ? true : card.cover?.isSizeOne
                );
              }}
