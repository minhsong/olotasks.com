...
export const timeStringToSeconds = (input: string): number => {
...
export const secondsToTimeString = (seconds: number): string | null => {
...
export const validateDurationString = (timeString: string): boolean => {
  const regex =
